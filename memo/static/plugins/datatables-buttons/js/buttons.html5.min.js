...
(g=e.messageTop+f+f+g);e.messageBottom&&(g=g+f+f+e.messageBottom);b.customize&&(g=b.customize(g,b,c));b=n("<textarea readonly/>").val(g).appendTo(d);if(x.queryCommandSupported("copy")){d.appendTo(c.table().container());b[0].focus();b[0].select();try{var p=x.execCommand("copy");d.remove();if(p){c.buttons.info(c.i18n("buttons.copyTitle","Copier dans le presse-papier"),c.i18n("buttons.copySuccess",{1:"Une ligne copiée dans le presse-papiers",_:"%d lignes copiées dans le presse-papiers"},a.rows),2E3);this.processing(!1);return}}catch(q){}}p=
n("<span>"+c.i18n("buttons.copyKeys","Appuyez sur <i>ctrl</i> ou <i>⌘</i> + <i>C</i> pour copier les données du tableau<br>dans votre presse-papiers système.<br><br>Pour annuler, cliquez sur ce message ou appuyez sur Échap.")+"</span>").append(d);c.buttons.info(c.i18n("buttons.copyTitle","Copier dans le presse-papier"),p,0);b[0].focus();b[0].select();var t=n(p).closest(".dt-button-info"),h=function(){t.off("click.buttons-copy");n(x).off(".buttons-copy");c.buttons.info(!1)};t.on("click.buttons-copy",h);n(x).on("keydown.buttons-copy",function(q){27===
